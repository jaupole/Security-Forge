...
1. Manually unseal the seal node: `bao operator unseal` ×3 against `openbao-seal-0` (see [openbao-seal-unseal.md](../03-runbooks/openbao-seal-unseal.md)) — paste 3 of the 5 unseal keys.

...
echo "  is the next step but is NOT done by this script. See:"
echo "    infrastructure/openbao/configure-engines.sh"
echo "    infrastructure/openbao/configure-auth-k8s-jwt.sh"
echo "    infrastructure/openbao/configure-auth-oidc.sh"
echo "    infrastructure/openbao/load-policies.sh"

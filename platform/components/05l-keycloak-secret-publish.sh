...
CLIENT_DESTINATIONS=(
  ...
  # project-manager (project_manager): user-login client + a system service
  # account (project-manager-system) for the configurable workflow gate.
  "project-manager-system|openbao://secret/apps/project-manager/runtime#system_client_secret"
